        ...
        <div class="p-12">
            ...
            <ul class="mx-auto max-w-screen-lg grid xl:grid-cols-2 grid-cols-1 gap-24">
                @foreach($projects as $project)
                    <li class="bg-white rounded-2xl overflow-hidden border border-neutral-200 shadow-sm hover:-translate-y-4 hover:scale-105 hover:z-10 transition transform">
                        <a class="block" href="{{ $project->website }}">
                            ...
                            <div class="p-6">
                                ...
                                <p class="text-neutral-600">{{ $project->excerpt }}</p>
                            </div>
                        </a>
                    </li>
                @endforeach
