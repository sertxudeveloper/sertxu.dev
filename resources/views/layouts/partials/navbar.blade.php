<!-- Navigation -->
<nav id="navbar" x-data="{ scrolled: false, open: false }" @scroll.window="scrolled = window.scrollY > 50"
    ...
    <div class="max-w-5xl mx-auto px-6 h-16 flex items-center justify-between">
        ...
        <button id="menu-btn" @click="open = !open" class="md:hidden text-text-primary p-2" aria-label="Toggle menu">
    ...
    <div id="mobile-menu" class="md:hidden border-t border-neutral-600 bg-neutral-950/95 backdrop-blur-lg" :class="open ? 'block' : 'hidden'">
        <div class="max-w-5xl mx-auto px-6 py-4 flex flex-col gap-3">
            ...
            <x-navbar.item :href="route('home') . '#contact'" :is-active="request()->routeIs('home') && request()->has('contact')" class="py-2">Contact</x-navbar.item>
        </div>
    </div>
</nav>
