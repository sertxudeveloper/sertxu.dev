...
<body class="font-sans antialiased bg-dark-300 relative" style="width: 640px; height: 360px;">
    ...
    <div class="absolute top-0 left-0 h-full w-full flex items-center px-5 max-w-md">
        <h1 class="text-white text-2xl font-medium text-left">How to solve "Unknown table 'COLUMN_STATISTICS'" at MySQL Workbench</h1>
    </div>
</body>
</html>
