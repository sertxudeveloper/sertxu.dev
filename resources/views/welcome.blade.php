...
@section('content')
    <section class="bg-dark-200 flex space-x-24 items-center justify-center py-32">
        ...
        <div class="text-center space-y-6">
            ...
            <p class="text-xl md:text-2xl sm:text-3xl text-gray-300">Full&#8209;stack developer, open&#8209;source maintainer,<br>and content creator.</p>

            <div class="flex space-x-4 justify-center pt-4">
                <a href="https://x.com/sertxudev" class="hover:bg-ocean hover:text-white border shadow-xs border-gray-300 bg-white/5 text-gray-300 flex h-12 items-center justify-center rounded-lg w-12 p-2.5">
                ...
                <a href="https://github.com/sertxudev" class="hover:bg-ocean hover:text-white border shadow-xs border-gray-300 bg-white/5 text-gray-300 flex h-12 items-center justify-center rounded-lg w-12 p-2.5">
                    <svg viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                ...
                <a href="https://linkedin.com/in/sertxudev" class="hover:bg-ocean hover:text-white border shadow-xs border-gray-300 bg-white/5 text-gray-300 flex h-12 items-center justify-center rounded-lg w-12 p-2.5">
                    <svg viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                ...
                <a href="mailto:hello@sertxu.dev" class="hover:bg-ocean hover:text-white border shadow-xs border-gray-300 bg-white/5 text-gray-300 flex h-12 items-center justify-center rounded-lg w-12 p-2.5">
                    <svg viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
    ...
    {{--<section class="bg-dark-200 py-24">
        <div class="max-w-screen-lg mx-auto">
            <h2 class="text-2xl text-gray-200 text-center font-medium">Education</h2>
            <div class="border-b-2 border-ocean w-32 mx-auto mt-2 mb-10"></div>
            <ul class="divide-y divide-gray-500 *:py-6 gap-12 mx-auto max-w-lg">
                @foreach($education as $el)
                    <li>
                        <div class="flex items-center justify-between">
                            <p class="text-lg text-gray-200">{{ $el->title }}</p>
                            <p class="text-gray-400 text-sm">{{ $el->started_at->format('Y') }} - {{ $el->ended_at?->format('Y') ?? 'Present' }}</p>
                        </div>
                        <div class="text-gray-300 [&_ul]:list-inside [&_ul]:list-disc [&_ul]:ml-4">
                            {!! Str::of($el->description)->markdown(); !!}
                        </div>
                        <p class="text-gray-400 text-sm mt-1">{{ $el->location }}</p>
                    </li>
                @endforeach
            </ul>
        </div>
